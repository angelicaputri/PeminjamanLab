...
<!-- dataTable -->
<link rel="stylesheet" href="<?php echo base_url('assets/templates/adminlte-2-3-11/plugins/datatables/jquery.dataTables.css'); ?>">
<script src="<?php echo base_url('assets/templates/adminlte-2-3-11/plugins/datatables/jquery.dataTables.js'); ?>"></script>
	<script type="text/javascript">
		$(document).ready( function () {
			$('#myTable').DataTable();
		} );
