						...
						<form id="input_form" action="<?php echo base_url('inventory/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea name="description" id="description" class="form-control" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"></textarea>
									</div>
								</div>
								<div class="form-group">
									<label for="serial_number" class="control-label col-md-2">No. HP Peminjam</label>
									<div class="col-md-8">
										<input type="number" name="serial_number" id="serial_number" class="form-control" required>
									</div>
								</div>
								<div class="form-group">
									<label for="hari" class="control-label col-md-2">Hari</label>
									<div class="col-md-2">
										<select name="hari" id="hari" class="form-control select2 required" style="width:100%">
								...
								<div class="form-group">
									...
									<div class="col-md-2">
										<input type="text" name="tanggal" class="tanggal form-control required" required>
									</div>
								</div>
								<div class="form-group">
									<label for="mulai" class="control-label col-md-2">Jam Mulai</label>
									<div class="col-md-2">
										<input type="time" name="mulai" id="mulai" class="form-control required" required>
									</div>
								</div>
								<div class="form-group">
									<label for="model" class="control-label col-md-2">Jam Selesai</label>
									<div class="col-md-2">
										<input type="time" name="model" id="model" class="form-control required" required>
									</div>
								</div>
