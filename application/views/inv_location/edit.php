			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<?php echo $message;?>
						<form action="<?php echo base_url('locations/edit/').$.jYYYY, ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							<?php foreach ($data_list->result() as $data){
								$curr_code      = $data->code;
								$curr_name      = $data->name;
								$curr_detail    = $data->detail;
								$curr_kalab    = $data->kalab;
							...
							<div class="form-group">
								<label for="kalab" class="control-label col-md-2">* Kepala Laboratorium</label>
								<div class="col-md-8 <?php if (form_error('kalab')) {echo "has-error";} ?>">
									<input type="text" name="kalab" id="kalab" class="form-control" value="<?php echo $curr_kalab; ?>" placeholder="Kepala Laboratorium" required>
								</div>
							</div>
							<div class="form-group">
