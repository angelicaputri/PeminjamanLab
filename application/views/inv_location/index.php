	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li class="active"><i class="fa fa-map-marker"></i> &nbsp; Laboratorium</li>
			</ol>
		</section>
		...
		<section class="content">
			...
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">Tambah Laboratorium
					</h3>
				...
				<div class="box-body <?php if (!isset($open_form)){ echo "hide";} ?>" id="add_new">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form action="<?php echo base_url('locations/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="name" class="control-label col-md-2">* Kepala Laboratorium</label>
								<div class="col-md-8 <?php if (form_error('name')) {echo "has-error";} ?>">
									<input type="text" name="kalab" id="kalab" class="form-control" value="<?php echo set_value('kalab'); ?>" placeholder="Kepala Laboratorium" required>
								</div>
							</div>
							<div class="form-group">
