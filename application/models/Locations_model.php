...
class Locations_model extends CI_Model
{
	...
	*
	*/
	public function get_locations($id='',$limit='', $start='', $order_method='asc')
	{
		$this->db->select(
	...
	*/
	...
	public function kalab_check($kalab)
	{
		$this->db->where('kalab', trim($kalab));
		$datas = $this->db->get($this->locations_table);
